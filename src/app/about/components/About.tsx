...
function About() {
    return (
        <div className="relative overflow-hidden lg:ml-5">
            ...
            <div
                aria-hidden
                className="pointer-events-none absolute right-0 top-0 h-4/5 w-5/6 bg-gradient-to-l from-red-600/50 via-red-500/30 to-transparent blur-2xl opacity-70"
            />

            <div className="grid grid-cols-1 lg:grid-cols-2 mt-20 relative z-10">
