...
function ContactUs() {
    return (
        ...
        <div className="relative overflow-hidden lg:ml-5">
            ...
            <div
                aria-hidden
                className="pointer-events-none absolute right-0 top-0 h-1/2 w-full sm:h-3/5 sm:w-3/4 bg-gradient-to-l from-red-600/50 via-red-500/30 to-transparent blur-2xl opacity-70"
            />

            <div className="grid grid-cols-1 lg:grid-cols-2 items-center mt-20 relative z-10 mb-4 sm:mb-0">
                    ...
                    <div className="flex items-center mb-2">
                        <div className="flex flex-col mb-2">
                            <h1 className="text-5xl sm:text-5xl font-extrabold leading-tight">
                                Get in Touch </h1>
                            <p className='text-5xl sm:text-5xl'>with</p>

                            <h1 className='text-red-500 text-5xl sm:text-5xl font-extrabold leading-tight'>QuickVote</h1>
                        </div>
                    </div>
                    <div className="mb-6">
                        <p className="text-gray-300 font-bold text-lg sm:text-lg">
                            "We're here to support you every step of the way."
                        </p>
                    </div>
                    <div className="flex flex-col sm:flex-row sm:flex-wrap gap-4 md:gap-8 mb-6 font-semibold">
